...
**Analyst:** Jonathan Lopez | **Region:** East (New York & Connecticut)

---

## Project Overview

This project analyzes four years of sales data (2022–2025) for the **East Region** of EmporiUm, a virtual student bookstore operating both in-store and online locations. The report was built in Power BI Desktop and is designed to be shared with the East Region's director, territory managers, and individual store managers to support data-driven business decisions.

The analysis covers in-store locations across **New York** and **Connecticut**, as well as online orders shipped to both states.
...
- **Pie/Donut Chart:** Relative sales by state (New York vs. Connecticut — in-store and online)
...
- Resolved ~7,900 null Category values in Store Sales (Art Supplies products imported as #N/A)
- Normalized column names across both fact tables and appended into a unified Sales table
- Filtered data to East Region only (Store IDs 840–872 for in-store; NY and CT for online)
- Built a custom DAX Calendar table spanning 2022–2025 with Year, Month, Quarter columns
